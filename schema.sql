...
CREATE TABLE IF NOT EXISTS `pokemons` (
  ...
  `combat_friendship_time` int unsigned NOT NULL DEFAULT 0,
  `shiny` boolean NOT NULL DEFAULT 0,
  `ability_id` smallint unsigned NOT NULL DEFAULT 0,
  `ability_slot` tinyint unsigned NOT NULL DEFAULT 0,
  `held_item_id` smallint unsigned NOT NULL DEFAULT 0,
  `evolution_seed` int unsigned NOT NULL DEFAULT 0,
  `pending_evolution` varchar(255) NOT NULL DEFAULT '',
...
INSERT INTO `server_config` (`config`, `value`) VALUES ('db_version', '41'), ('motd_hash', ''), ('motd_num', '0'), ('players_record', '0'), ('pokemon_uid', '0');

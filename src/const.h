...
enum PlayerFlags : uint64_t {
	...
	PlayerFlag_IgnorePokemonLevelLimit = static_cast<uint64_t>(1) << 38,
};
...
enum PlayerCooldown_t : uint8_t {
	...
	PLAYER_COOLDOWN_POTION,
	PLAYER_COOLDOWN_REVIVE,
	PLAYER_COOLDOWN_CURE,
};

enum EvolutionTime_t : uint8_t {
	EVOLUTION_TIME_ANY,
	EVOLUTION_TIME_DAY,
	EVOLUTION_TIME_NIGHT,
};

enum EvolutionStatComparison_t : uint8_t {
	EVOLUTION_STAT_NONE,
	EVOLUTION_STAT_ATTACK_GREATER_THAN_DEFENSE,
	EVOLUTION_STAT_ATTACK_EQUAL_DEFENSE,
	EVOLUTION_STAT_ATTACK_LESS_THAN_DEFENSE,
};
